...
SELECT	'Players:Expansion1_Players',
	...
	LeaderAbilityIcon
FROM Players 
WHERE Domain <> 'Players:Expansion1_Players' AND LeaderType = 'LEADER_MRK_SARMIENTO';
...
SELECT	'Players:Expansion2_Players',
	...
	LeaderAbilityIcon
FROM Players
WHERE Domain <> 'Players:Expansion2_Players' AND LeaderType = 'LEADER_MRK_SARMIENTO';
