...
VALUES	('MRK_SARMIENTO_STRENGTH_VS_BARBS',		'MODIFIER_PLAYER_UNITS_ADJUST_BARBARIAN_COMBAT',	null,						1),
		('ABILITY_MRK_SARMIENTO_UNITS_PRO',		'MODIFIER_PLAYER_UNITS_ADJUST_COMBAT_STRENGTH',		null,						null),
		('ABILITY_MRK_SARMIENTO_UNITS_CON',		'MODIFIER_PLAYER_UNITS_ADJUST_COMBAT_STRENGTH',		null,						null);

INSERT OR REPLACE INTO ModifierArguments
		(ModifierId,							Name,		Value)
VALUES	('MRK_SARMIENTO_STRENGTH_VS_BARBS',		'Amount',	5),
		('ABILITY_MRK_SARMIENTO_UNITS_PRO',		'Amount',	1),
		('ABILITY_MRK_SARMIENTO_UNITS_CON',		'Amount',	-1);
