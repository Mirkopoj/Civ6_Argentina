...
VALUES		('BUILDING_MRK_BIB_POPULAR',	'MRK_SCIENCE_PER_POP_4'),
			('BUILDING_MRK_BIB_POPULAR',	'MRK_SCIENCE_PER_POP_8'),
			('BUILDING_MRK_BIB_POPULAR',	'MRK_SCIENCE_PER_POP_12'),
			('BUILDING_MRK_BIB_POPULAR',	'MRK_SCIENCE_PER_POP_16'),
			('BUILDING_MRK_BIB_POPULAR',	'MRK_SCIENCE_PER_POP_20'),
			('BUILDING_MRK_BIB_POPULAR',	'MRK_SCIENCE_PER_POP_24'),
			('BUILDING_MRK_BIB_POPULAR',	'MRK_SCIENCE_PER_POP_28'),
			('BUILDING_MRK_BIB_POPULAR',	'MRK_SCIENCE_PER_POP_32'),
			('BUILDING_MRK_BIB_POPULAR',	'MRK_SCIENCE_PER_POP_36'),
			('BUILDING_MRK_BIB_POPULAR',	'MRK_SCIENCE_PER_POP_40');
...
VALUES		('MRK_SCIENCE_PER_POP_4',	'BuildingType',	'BUILDING_MRK_BIB_POPULAR'),
			('MRK_SCIENCE_PER_POP_4',	'YieldType',	'YIELD_SCIENCE'),
			('MRK_SCIENCE_PER_POP_4',	'Amount',		1),
			('MRK_SCIENCE_PER_POP_8',	'BuildingType',	'BUILDING_MRK_BIB_POPULAR'),
			('MRK_SCIENCE_PER_POP_8',	'YieldType',	'YIELD_SCIENCE'),
			('MRK_SCIENCE_PER_POP_8',	'Amount',		2),
			('MRK_SCIENCE_PER_POP_12',	'BuildingType',	'BUILDING_MRK_BIB_POPULAR'),
			('MRK_SCIENCE_PER_POP_12',	'YieldType',	'YIELD_SCIENCE'),
			('MRK_SCIENCE_PER_POP_12',	'Amount',		3),
			('MRK_SCIENCE_PER_POP_16',	'BuildingType',	'BUILDING_MRK_BIB_POPULAR'),
			('MRK_SCIENCE_PER_POP_16',	'YieldType',	'YIELD_SCIENCE'),
			('MRK_SCIENCE_PER_POP_16',	'Amount',		4),
			('MRK_SCIENCE_PER_POP_20',	'BuildingType',	'BUILDING_MRK_BIB_POPULAR'),
			('MRK_SCIENCE_PER_POP_20',	'YieldType',	'YIELD_SCIENCE'),
			('MRK_SCIENCE_PER_POP_20',	'Amount',		5),
			('MRK_SCIENCE_PER_POP_24',	'BuildingType',	'BUILDING_MRK_BIB_POPULAR'),
			('MRK_SCIENCE_PER_POP_24',	'YieldType',	'YIELD_SCIENCE'),
			('MRK_SCIENCE_PER_POP_24',	'Amount',		6),
			('MRK_SCIENCE_PER_POP_28',	'BuildingType',	'BUILDING_MRK_BIB_POPULAR'),
			('MRK_SCIENCE_PER_POP_28',	'YieldType',	'YIELD_SCIENCE'),
			('MRK_SCIENCE_PER_POP_28',	'Amount',		7),
			('MRK_SCIENCE_PER_POP_32',	'BuildingType',	'BUILDING_MRK_BIB_POPULAR'),
			('MRK_SCIENCE_PER_POP_32',	'YieldType',	'YIELD_SCIENCE'),
			('MRK_SCIENCE_PER_POP_32',	'Amount',		8),
			('MRK_SCIENCE_PER_POP_36',	'BuildingType',	'BUILDING_MRK_BIB_POPULAR'),
			('MRK_SCIENCE_PER_POP_36',	'YieldType',	'YIELD_SCIENCE'),
			('MRK_SCIENCE_PER_POP_36',	'Amount',		9),
			('MRK_SCIENCE_PER_POP_40',	'BuildingType',	'BUILDING_MRK_BIB_POPULAR'),
			('MRK_SCIENCE_PER_POP_40',	'YieldType',	'YIELD_SCIENCE'),
			('MRK_SCIENCE_PER_POP_40',	'Amount',		10);
