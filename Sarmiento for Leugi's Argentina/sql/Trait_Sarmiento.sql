...
VALUES	('TRAIT_LEADER_MRK_SARMIENTO',	'MRK_SARMIENTO_UNITS'),
		...
		('TRAIT_LEADER_MRK_SARMIENTO',	'MRK_SARMIENTO_STRENGTH_PER_TECH');
...
VALUES	('MRK_SARMIENTO_UNITS',				'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					0,			1,			null,					null),
		...
		('MRK_SARMIENTO_STRENGTH_PER_TECH',	'MODIFIER_PLAYER_UNIT_ADJUST_COMBAT_STRENGTH',			0,			1,			null,					'REQUIREMENTS_OPPONENT_IS_MAYOR_CIV');
